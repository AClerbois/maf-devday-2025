...
//     }
//     else if (evt is Microsoft.Agents.AI.Workflows.WorkflowOutputEvent completed)
//     {
...
// {
//     Console.WriteLine($"{message.Role}: {message.Contents.First()}");
// }
...
var workflow = new WorkflowBuilder(startExecutor)
    ...
    .AddFanInEdge(aggregationExecutor, [physicist, chemist])
...
await foreach (WorkflowEvent evt in run.WatchStreamAsync())
{
    ...
    {
        Console.WriteLine($"Executor {executorFailedEvent.ExecutorId} failed with error:\n{executorFailedEvent.Data}");
    }
}
    ...
    Executor<string>("ConcurrentStartExecutor")
{
    ...
    {
        Console.WriteLine("Starting concurrent agents... message: " + message);
        ...
        Console.WriteLine("Message sent to agents.");
        ...
        Console.WriteLine("End concurrent agents...");
    }
}
    ...
    Executor<List<ChatMessage>>("ConcurrentAggregationExecutor")
{
    ...
    {
        System.Console.WriteLine("Aggregating results from agents...");
